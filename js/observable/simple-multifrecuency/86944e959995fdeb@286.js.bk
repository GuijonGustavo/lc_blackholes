// https://observablehq.com/@d3/multi-line-chart@286
export default function define(runtime, observer) {
  const main = runtime.module();
  const fileAttachments = new Map([["unemployment.tsv",new URL("./files/lc_transpose.dat",import.meta.url)]]);
  main.builtin("FileAttachment", runtime.fileAttachments(name => fileAttachments.get(name)));
  main.variable(observer()).define(["md"], function(md){return(
md`# Multi-Frecuency Chart Mrk421

Student: Gustavo Magallanes-Guijon.
