...
//
// numbers of lines. Regularly the memory location error is in this matrix
double matrixdata[1000000][10]; //x-rays
//double matrixdata[10000][10]; //gamma
...
//Open datafilewrite:
  ...
  //datafileread = fopen("x-rays.dat", "r");
  //datafileread = fopen("mrk421_gamma.dat", "r");
  //datafileread = fopen("optical.dat", "r");
  datafileread = fopen("mrk421_radio.dat", "r");
